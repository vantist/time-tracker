...
- [x] 2.5 實作 TestIntegration_MultiToolIntegration 測試案例，模擬 Claude Code、Copilot CLI、Google Antigravity 的 stdin 與 log 檔案，驗證寫入與 token 解析

## 3. 測試驗證

- [x] 3.1 執行 `go test -v ./cmd/tt/...` 確保所有新增的整合測試案例皆順利通過
